...
<div id="slideset-<?php echo $widget_id; ?>" class="yoo-wk wk-slideset wk-slideset-default" data-widgetkit="slideset"
                    ...
                    <?php foreach ($items as $key => $image) :
                        ...
                        <li>
                            <article class="wk-content">
                                <a <?php echo $rel ?>class=""
                                   style="<?php echo 'width: ' . $image['width'] . 'px;'; ?>" <?php echo $link ?> <?php echo $lightbox; ?> <?php echo $spotlight; ?>><?php echo $content; ?></a>
                            </article>
                        </li>
