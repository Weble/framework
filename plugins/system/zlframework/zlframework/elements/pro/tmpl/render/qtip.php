                ...
                content: {
                    ...
                    ajax: {
                        ...
                        success: function (data, status) {
                            ...
                            <?php echo($lparams->find('qtip._button')); ?> &&
                            (options.content.title.button = true);
                            ...
                            options.content.title.text = (<?php echo (int)($lparams->find('qtip._title') == 'loadeditemname'); ?> && title.html()
                            ) ||
