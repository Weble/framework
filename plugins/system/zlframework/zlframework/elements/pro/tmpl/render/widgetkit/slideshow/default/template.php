...
<div id="slideshow-<?php echo $widget_id; ?>" class="yoo-wk wk-slideshow wk-slideshow-default"
     data-widgetkit="slideshow" data-options='<?php echo json_encode($settings); ?>'>
    <div>
        <ul class="slides">
        ...
        <?php if (!isset($settings['zl_captions']) || $settings['zl_captions']): ?>
