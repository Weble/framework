...
<div id="showcase-<?php echo $widget_id; ?>" class="yoo-wk wk-slideshow-showcasebuttons" data-widgetkit="showcase"
    ...
    <div id="slideset-<?php echo $widget_id; ?>"
        ...
        <div>
            ...
            <?php if ($settings->get('slideset_buttons') && count($sets) > 1): ?>
                <div class="next"></div>
                <div class="prev"></div><?php endif; ?>
        </div>
    </div>
