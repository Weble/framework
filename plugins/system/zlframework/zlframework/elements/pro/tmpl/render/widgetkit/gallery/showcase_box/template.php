...
<?php if (count($images)) : ?>
    <div id="gallery-<?php echo $widget_id; ?>" class="yoo-wk wk-gallery-showcasebox" data-widgetkit="showcase"
         data-options='<?php echo json_encode($settings); ?>'>
        ...
        <div id="slideshow-<?php echo $widget_id; ?>" class="wk-slideshow">
            <div class="slides-container">
                ...
                <?php if ($settings['buttons']): ?>
                    <div class="next"></div>
                    <div class="prev"></div><?php endif; ?>
                <?php if ($settings->get('zl_captions')) : ?>
                    <div class="caption"></div>
                    <ul class="captions"><?php echo implode('', $captions); ?></ul><?php endif; ?>
            </div>
        </div>

        <div id="slideset-<?php echo $widget_id; ?>"
             class="wk-slideset <?php if (!$settings['slideset_buttons']) echo 'no-buttons'; ?>">
            <div>
                <div class="sets">
                ...
                <?php if ($settings['slideset_buttons'] && count($sets) > 1) : ?>
                    <div class="next"></div>
                    <div class="prev"></div><?php endif; ?>
            </div>
        </div>
