...
<?php if (count($images)) : ?>
    <div class="yoo-wk wk-gallery-slider" id="gallery-slider-<?php echo $widget_id; ?>" data-widgetkit="gallery-slider"
        ...
        <ul class="slides">
            ...
            <?php foreach ($images as $key => $image) : ?>
                ...
                <?php if ($settings->get('lightbox') || strlen($image['link'])) : ?>
                    <li <?php echo $background; ?>><a <?php echo $rel ?>class=""
